...
function CampaignDetails() {
    ...
    useEffect(() => {
        const getCampaignDetail = async () => {
            ...
            setCampaign(data); // Set the fetched campaign data
        };
  ...
  const handleDeleteCampaign = async (campaignId: string) => {
    ...
    if (!campaign) return <p>Loading...</p>; // Show loading state until data is fetched
        ...
        <div>
            <div>
                ...
                <div className="flex gap-6 mt-3 text-[#555657] flex-wrap">
                    ...
                    <div className="flex gap-2">
                        <img src={Time} alt="" />
                        <p>{new Date(campaign.endDate).toLocaleDateString()} left</p>
                    </div>
                </div>
            ...
            <div>
                <h1 className="mt-2 font-bold text-xl">Why this Campaign is Important</h1>
            ...
            <div>
                ...
                <div className="flex gap-14 flex-wrap">
                    <div className="flex gap-2">
                        <img src={People} alt="" />
                        <h1>{campaign.createdBy.name ? campaign.createdBy.name : "Unknown Creator"}</h1>
                    </div>
                    ...
                    <div className="flex gap-2">
                        <img src={Call} alt="" />
                        <h1>+234(0)910877896</h1> {/* Update with actual phone number if available */}
                    </div>
                </div>
            </div>
            ...
            <div className="flex  mt-7  flex-wrap">
                <div className="flex gap-2 py-2 px-10 border-2 border-[#CA200D] mb-24 hover:bg-[#CA200D] flex-wrap">
                    <button onClick={handleDeleteCampaign(campaign._id)} className="text-[#CA200D] hover:text-[#ffff]">Delete</button>
                    <img src={Delete} alt="" />
                </div>
            </div>
